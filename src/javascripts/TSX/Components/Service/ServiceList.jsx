        ...
        <div className="serviceWrap">
          ...
          <div className="serviceItem">
            ...
            <div className="serviceItem__info">
              <h3 className="serviceItem__info--title">
                マツダジャストフィット車検
              </h3>
              ...
              <div className="serviceItem__info--btn">
                <Link className="serviceItem__info--btnLink" to="/guide">
                  VIEW ALL
                  <span className="serviceItem__info--btnLink--arrow ">＞</span>
                </Link>
              </div>
            </div>
          </div>
            ...
            <div className="wrapper">
              <div className="serviceItem__info extra">
                ...
                <div className="serviceItem__info--btn BottomLine">
                  <Link className="serviceItem__info--btnLink" to="/guide">
                    VIEW ALL
                    <span className="serviceItem__info--btnLink--arrow ">
                      ＞
                    </span>
                  </Link>
                </div>
              ...
              <div className="serviceItem__info extra">
                <h3 className="serviceItem__info--title small">
                  新車６ヶ月点検
                </h3>
                <p className="serviceItem__info--text mid">
                  ディーラーならではの確かな技術をベースに、お客様のご要望に応じて内容を自由に選べる安心、納得のディーラー車検です。
